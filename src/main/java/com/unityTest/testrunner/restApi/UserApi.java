...
public interface UserApi extends BaseApi {
	...
	/**
	 * GET endpoint to retrieve test suites created by the user Filter by id, assignment id, name and
	 * programming language
	 * 
	 * @return Pageable view of test suites matching query criteria created by the user
	 */
	@ApiOperation(
		value = "Retrieve a pageable view of test suites created by the user",
		nickname = "getUserTestSuites",
	...
	/**
	 * GET endpoint to retrieve test cases written by the user Filter by id, suite id, function name and
	 * programming language
	 * 
	 * @return Pageable view of test cases matching query criteria created by the user
	 */
	@ApiOperation(
		value = "Retrieve a pageable view of test cases written by the user",
		nickname = "getUserTestCases",
		produces = MediaType.APPLICATION_JSON_VALUE)
	...
	/**
	 * GET endpoint to retrieve recent user code uploads Filter by submission id
	 * 
	 * @return Pageable view of user code uploads that match query criteria
	 */
	@ApiOperation(
		value = "Get a pageable view of user's recent code uploads",
		nickname = "getRecentUserCodeUploads",
		response = SubmissionEventPage.class,
		produces = MediaType.APPLICATION_JSON_VALUE)
