...
public abstract class SpecificationBuilder<T> {
	...
	public SpecificationBuilder<T> after(Date date, String attr, String... attrs) {
		if (date != null)
			this.combineAndSetSpecification(this.buildSpec(Operator.AFTER, date, attr, attrs));
		return this;
	}
	...
	public SpecificationBuilder<T> before(Date date, String attr, String... attrs) {
		if (date != null)
			this.combineAndSetSpecification(this.buildSpec(Operator.BEFORE, date, attr, attrs));
		return this;
	}
