...
public class UserController implements UserApi {
	...
	@Override
	public ResponseEntity<SuitePage> getUserTestSuites(
			Principal principal,
			Pageable pageable,
			Integer id,
	...
	@Override
	public ResponseEntity<TestCasePage> getUserTestCases(
			Principal principal,
			Pageable pageable,
			Integer id,
			Integer suiteId,
	...
	@Override
	public ResponseEntity<SubmissionEventPage> getRecentUserCodeUploads(
			Principal principal,
			Pageable pageable,
		...
		Specification<Submission> spec = new AndSpecification<Submission>()
			...
			.after(TEN_DAYS_AGO, Submission_.SUBMISSION_DATE)
			.getSpec();
