package com.unityTest.testrunner.models.api.request;
...
/**
 * Models the core information needed to create or modify a test case for a test suite Used as the
 * body of the request for the POST and PUT /case endpoints
 */
@AllArgsConstructor
...
public class TestCaseInfo {
	...
	// Code body of test case, used in conjunction with the name to create a working code snippet
	// representing
